...
extern void test_flashWriteData_should_write_0_to_34_from_address_30_to_130_should_return_50(void);
...
int main(void)
{
  ...
  RUN_TEST(test_flashWriteData_should_write_0_to_34_from_address_30_to_130_should_return_50, 509);
